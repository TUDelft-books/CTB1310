...
Wat is de absolute waarde van de maximale spanning ten gevolge van buiging?
...
$$I_{zz} = \frac{1}{12} \cdot 300 \cdot 12^3 + \frac{1}{12} \cdot 12 \cdot 300^3 = 86400 \, \rm{mm}^4$$
...
$$\left| \tau \right| = \cfrac{\left| 1152 \cdot 135000 \right|}{12 \cdot 86400} = 150 \, \rm{MPa}$$
::::
...
Wat is de richting van de maximale schuifspanning ten gevolge van alleen buiging op een positieve doorsnede?
...
Het verdeelde wringend moment is $576 \cdot \bar y_{\rm{N.C.}} = 576 \cdot 0.075 = 43.2 \, \rm{Nm/m}$
...
-M_{\rm{t,B}} + 43.2 \cdot 3 - 604.8 &= 0 \\
M_{\rm{t,B}} &= -518.4 \, \rm{Nm}
\end{align*}
$$
...
Wat is de absolute waarde van de maximale spanning ten gevolge van wringing?
% Geef je antwoord in $\rm{MPa}$.
...
$$ \tau = \cfrac{518.4 \cdot 10^3 \cdot 6}{\frac{1}{2} \cdot \left( \frac{1}{3} \cdot 300 \cdot 12^3 + \frac{1}{3} \cdot 300 \cdot 12^3 \right)} = 18 \, \rm{MPa}$$
...
Wat is de richting van de schuifspanning ten gevolge van alleen wringing op een positieve doorsnede?
